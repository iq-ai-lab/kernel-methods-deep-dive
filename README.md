...
[![Ch7](https://img.shields.io/badge/🔹_Ch7-Random_Features·NTK-7A4ED9?style=for-the-badge)](./ch7-advanced-kernel/01-multiple-kernel-learning.md)
...
> 💡 **챕터별 총 정리 수**: Ch1(12) · Ch2(13) · Ch3(14) · Ch4(16) · Ch5(10) · Ch6(9) · Ch7(8) — 합계 **82개 정리 + 증명**, 약 **17,000+ 라인** 분량.
...
>
> ⏱️ **학습 시간 추정**: 문서당 평균 490줄(증명·코드·연습문제 포함) 기준 **약 1~1.5시간**. 전체 35문서는 약 **40~50시간** 상당.
